import{f as g,a as l}from"../chunks/pLS1xZ2u.js";import{o as y}from"../chunks/DT17TMml.js";import{Z as T,a0 as W,R as v,a1 as C,a5 as P,_ as x,a2 as m,ak as S,a3 as p,a4 as h,f as c}from"../chunks/cQZEWYEV.js";import{i as I}from"../chunks/BQWQbLOb.js";import{h as M}from"../chunks/rk0md2lh.js";import{a as G}from"../chunks/DIx0-kbF.js";import{p as q,B as D}from"../chunks/BaLhmtrD.js";const A=""+new URL("../assets/CPMSocGroupPhotoSmall.CX5V8DAD.webp",import.meta.url).href,O=`# Programming 2026
...
`;var j=g(`<div class="flex flex-col gap-4
            [&amp;>ul]:list-disc [&amp;>ul]:list-outside [&amp;>ul]:pl-5 [&amp;>ul]:text-xl [&amp;>ul]:leading-relaxed [&amp;>ul]:ml-5 [&amp;>ul]:space-y-1"><!></div>`),R=g('<div class="group relative flex justify-center items-center w-full md:h-[220px] h-[200px] overflow-hidden bg-black"><img alt="CPMSoc Workshop Group" class="absolute inset-0 w-full h-full object-cover brightness-75 object-[center_20%] blur-[1px] select-none scale-105"/> <div class="flex items-center justify-center z-10"><h1 class="text-white font-[800] tracking-[0.1em] text-[12vw] lg:text-[120px]">WORKSHOPS</h1></div></div> <div class="max-w-[1000px] mx-auto gap-4 flex flex-col py-6 px-10"><h1 class="text-5xl font-bold text-[#5b8ddb] tracking-tight">Workshops</h1> <!></div>',1);function H(_,u){T(u,!0);let r=x("");function f(e){const s=new D,i={heading(o){return`<h1 class="text-4xl font-bold text-[#5b8ddb] tracking-tight mt-2">${o.text}</h1>`},link(o){let n=o.href;return!n.startsWith("http")&&!n.startsWith("https")&&!n.startsWith("/")&&(n=`/workshops/${n}`),`<a href="${n}" target="_blank" rel="noreferrer" class="text-[#7862e2] hover:underline">${o.text}</a>`},paragraph(o){return`<p class="text-xl leading-relaxed mb-4">${o.text}</p>`}};return s.use({renderer:i}),s.parse(e)}y(()=>{const e=f(O);P(r,q.sanitize(e,{ALLOWED_TAGS:["h1","h2","h3","h4","h5","h6","p","ul","ol","li","a","br"],ALLOWED_ATTR:["href","target","rel","class"]}),!0)});var a=R(),t=W(a),w=m(t);S(2),p(t);var d=h(t,2),k=h(m(d),2);{var b=e=>{var s=j(),i=m(s);M(i,()=>c(r)),p(s),l(e,s)};I(k,e=>{c(r)&&e(b)})}p(d),v(()=>G(w,"src",A)),l(_,a),C()}export{H as component};
